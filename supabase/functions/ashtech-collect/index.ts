...
const COUNTRY_CURRENCY: Record<string, string> = {
  CM: "XAF", CF: "XAF", CG: "XAF", GA: "XAF", GQ: "XAF", TD: "XAF", CD: "CDF",
  BJ: "XOF", BF: "XOF", CI: "XOF", GW: "XOF", ML: "XOF", NE: "XOF", SN: "XOF", TG: "XOF", GN: "GNF",
  KE: "KES", UG: "UGX", TZ: "TZS", RW: "RWF", MG: "MGA",
  NG: "NGN", GH: "GHS", ZA: "ZAR"
};

const CURRENCY_RATES: Record<string, number> = {
  XAF: 1, XOF: 1, USD: 600, EUR: 655, NGN: 0.4, KES: 4.5, GHS: 38, CDF: 0.33, ZAR: 32, UGX: 0.16, TZS: 0.23, RWF: 0.6, MGA: 0.16, GNF: 0.06
};
